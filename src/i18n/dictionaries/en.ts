...
export const en: Dictionary = {
  ...
  experience: {
    ...
    jobs: [
      ...
      {
        role: "Early Years Technician (TEI)",
        place: "Escola Emili Vallès, Igualada · I3",
        dates: "2022–2024",
        desc: "Support in the I3 class (age 3): contributing to classroom planning, supporting daily routines (arrival, hygiene, meals and rest), giving individual attention and preparing materials and spaces.",
      },
      {
