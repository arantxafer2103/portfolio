...
export const es: Dictionary = {
  ...
  experience: {
    ...
    jobs: [
      ...
      {
        role: "Técnica de Educación Infantil (TEI)",
        place: "Escola Emili Vallès, Igualada · I3",
        dates: "2022–2024",
        desc: "Apoyo en el aula de I3 (3 años): participación en las programaciones de aula, acompañamiento en las rutinas (acogida, higiene, alimentación y descanso), atención individualizada y preparación de materiales y espacios.",
      },
      {
